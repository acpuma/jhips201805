...
public class Jhips201805App {

    private static final Logger log = LoggerFactory.getLogger(Jhips201805App.class);

    private final Environment env;

    public Jhips201805App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhips201805.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Jhips201805App.class);
